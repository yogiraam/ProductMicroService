...
public class WebController {
	...
	public List<Product> p3(@PathVariable String dealer) throws Exception {
		System.out.println(" --->> 1 Inside controller " + dealer);
		return productService.getAllProductsByDealerName(dealer);
	}

	@GetMapping("/product/{category}")
	public List<Product> p4(@PathVariable String category) throws Exception {
