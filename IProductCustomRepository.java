...
public interface IProductCustomRepository {
	...
	public List<Product> getProductsByCategoryAndPriceRangeAndDealerName(@Param ("category")String category , @Param("price1") float price1,@Param("price2") float price2,@Param("dealerName") String dealerName) throws Exception;
